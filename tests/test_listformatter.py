...
get_xws_tests = (
    ...
    (
        ...
        {"faction": "scumandvillainy", "pilots": [{"id": "sunnybounder", "ship": "m3ainterceptor", "upgrades": {
            "cannon": ["heavylasercannon"]}, "points":32}], "name": "Sunny B!", "description": "", "points": 32, 'vendor': {'squad2xws': {'builder': 'squad2xws',  'url': 'http://squad2xws.herokuapp.com/translate/d0966452-ec40-40d4-a3cd-ff384e1dcf70'}}}
    ),
    (
