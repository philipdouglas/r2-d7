...
print_xws_tests = (
    pytest.param(
        ...
        [
            ...
            ':m3ainterceptor::initiative1: _<https://xwingtmgwiki.com/Sunny_Bounder|Sunny Bounder>_: <https://xwingtmgwiki.com/Heavy_Laser_Cannon|Heavy Laser Cannon> *[31]*',
        ],
    ),
    (
    ...
    (
        ...
        [
            ...
            ':btla4ywing::initiative5: _<https://xwingtmgwiki.com/Norra_Wexley|Norra Wexley>_ *[40]*',
            ':t65xwing::initiative5: _<https://xwingtmgwiki.com/Luke_Skywalker|Luke Skywalker>_: <https://xwingtmgwiki.com/R2-D2|R2-D2> *[68]*',
        ]
    )
)
