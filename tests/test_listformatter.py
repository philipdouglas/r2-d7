...
get_xws_tests = (
    ...
    (
        ...
        {"faction": "scumandvillainy", "pilots": [{"id": "sunnybounder", "ship": "m3ainterceptor", "upgrades": {
            "cannon": ["heavylasercannon"]}, "points":34}], "name": "Sunny B!", "description": "", "points": 34}
    ),
    (
...
print_xws_tests = (
    ...
    (
        ...
        [
            ':rebel: *<https://raithos.github.io/?f=Rebel%20Alliance&d=v4!s!25:-1,-1,-1,-1,-1,-1,-1:-1:-1:;4:-1,-1,3,-1,-1:-1:-1:&sn=Unnamed%20Squadron&obs=|Nameless Squadron>* *[109]*',
